...
public class Data
{
	 ...
	 */
	public final java.util.Date getTanggalLahir()
	{
	 ...
	 * @return value of TanggalLahir
	 */
	public final java.util.Date getTanggalLahir(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (java.util.Date) getMendixObject().getValue(context, MemberNames.TanggalLahir.toString());
	}
	 ...
	 * @param tanggallahir
	 */
	public final void setTanggalLahir(java.util.Date tanggallahir)
	{
	 ...
	 * @param tanggallahir
	 */
	public final void setTanggalLahir(com.mendix.systemwideinterfaces.core.IContext context, java.util.Date tanggallahir)
	{
